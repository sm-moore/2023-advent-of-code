...
mod tests {
    ...
    #[test]
    fn test_day1_test() {
        assert_eq!(day1("src/testinput.txt"), 142);
    }
    ...
    fn test_day1_pt2_test() {
        assert_eq!(day1_pt2("src/testpt2.txt"), 281);
    }
    ...
    fn test_read_lines() {
        ...
        assert_eq!(read_lines("src/testinput.txt"), expected);
    }
}


fn main() {
    println!("{:?}", day1("src/input1.txt"));
    println!("{:?}", day1_pt2("src/input1.txt"));
}